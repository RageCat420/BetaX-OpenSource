...
public class OyveyExplosionUtil {
    ...
    public static float calculateDamage(double posX, double posY, double posZ, Entity entity, Entity predict, float power) {
        ...
        if (entity instanceof LivingEntity) {
            finald = getBlastReduction((LivingEntity) entity, getDamageMultiplied(damage), new Explosion(mc.world, entity, posX, posY, posZ, power, false, Explosion.DestructionType.DESTROY));
        }
        return (float) finald;
    }
